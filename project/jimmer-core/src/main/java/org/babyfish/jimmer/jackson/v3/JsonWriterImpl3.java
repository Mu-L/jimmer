...
public class JsonWriterImpl3 implements JsonWriter {
    private final ObjectWriter objectWriter;

    public JsonWriterImpl3(ObjectWriter objectWriter) {
        this.objectWriter = objectWriter;
    }

    @Override
    public JsonWriter withDefaultPrettyPrinter() {
        return new JsonWriterImpl3(objectWriter.withDefaultPrettyPrinter());
    }
