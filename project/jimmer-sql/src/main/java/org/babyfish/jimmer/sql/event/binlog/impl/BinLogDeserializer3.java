...
import org.babyfish.jimmer.jackson.v3.NodeImpl3;
...
class BinLogDeserializer3 extends StdDeserializer<Object> {

    private final BinLogParser parser;

    private final ImmutableType immutableType;

    public BinLogDeserializer3(
            BinLogParser parser,
    ...
    public Object deserialize(JsonParser p, DeserializationContext ctxt) throws JacksonException {
        ...
        return Internal.produce(immutableType, null, draft -> {
            ...
            while (itr.hasNext()) {
                ...
                ValueParser.addEntityProp((DraftSpi) draft, chain, new NodeImpl3(childNode), parser);
            }
